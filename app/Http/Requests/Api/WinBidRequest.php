...
class WinBidRequest extends FormRequest
{
    ...
    public function rules()
    {
        ...
        return [
            ...
            'project_manager' => ['bail','required','exists:project_managers,name'],
            'business_channel' => ['bail','required','exists:business_channels,name'],
            'partner' => ['bail','required','exists:partners,name'],
